...
func (r *RawClient) GetPlans(
	ctx context.Context,
	opts ...option.RequestOption,
) (*core.Response[*predictorsdk.PlansResponse], error) {
	...
	var response *predictorsdk.PlansResponse
	...
	return &core.Response[*predictorsdk.PlansResponse]{
...
func (r *RawClient) GetCategories(
	ctx context.Context,
	opts ...option.RequestOption,
) (*core.Response[*predictorsdk.CategoriesResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	endpointURL := baseURL + "/v1/categories"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
	var response *predictorsdk.CategoriesResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*predictorsdk.CategoriesResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) GetEvent(
	...
	opts ...option.RequestOption,
) (*core.Response[*predictorsdk.EventResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *predictorsdk.EventResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*predictorsdk.EventResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
