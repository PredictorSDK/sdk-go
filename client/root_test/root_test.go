...
func TestGetSportsMatchingMarketsWithWireMock(
	...
	_, invocationErr := client.GetSportsMatchingMarkets(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestGetSportsMatchingMarketsWithWireMock"}},
		),
	)
...
func TestGetBinanceCryptoPricesWithWireMock(
	...
	_, invocationErr := client.GetBinanceCryptoPrices(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestGetBinanceCryptoPricesWithWireMock"}},
		),
	)
